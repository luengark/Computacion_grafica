...
//************************************************************//
//************************************************************//
//************** Alumno (s): Luis Enrique García Rosales*********************************//
//*************											******//
//*************											******//
//************************************************************//
#include "Main.h"
...
GLfloat JupiterDiffuse[] = { 1.0f, 0.4f, 0.4f, 1.0f };			// Júpiter
...
GLfloat GanymedeDiffuse[] = { 0.7f, 0.7f, 0.7f, 1.0f };			// Ganímedes
...
GLfloat TitanDiffuse[] = { 0.7f, 0.7f, 0.7f, 1.0f };			// Titán
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glutSolidSphere(0.5, 10, 10); //Titán
		glPopMatrix();
		glPushMatrix();

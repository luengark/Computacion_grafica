...
float cerrarLlanta = 0.0;
bool adelante = true;
bool retroceso = false;
bool rotacion = false;
bool rotacion_anti = false;
float rot = 0;
	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glRotatef(cerrarLlanta, 0.0, 0.0, 1.0);
				llanta.GLrender(NULL, _SHADED, 1.0); //Del-Der
				glPopMatrix();
				...
				glRotatef(-giroLlanta, 1.0, 0.0, 0.0);
				glRotatef(cerrarLlanta, 0.0, 0.0, 1.0);
				llanta.GLrender(NULL, _SHADED, 1.0); //Del-Izq
				glPopMatrix();
				...
				glRotatef(giroLlanta, 1.0, 0.0, 0.0);
				glRotatef(cerrarLlanta, 0.0, 0.0, 1.0);
				llanta.GLrender(NULL, _SHADED, 1.0); //Tras-Der
				glPopMatrix();
				...
				glRotatef(-giroLlanta, 1.0, 0.0, 0.0);
				glRotatef(cerrarLlanta, 0.0, 0.0, 1.0);
				llanta.GLrender(NULL, _SHADED, 1.0); //Tras-Izq
				glPopMatrix();
